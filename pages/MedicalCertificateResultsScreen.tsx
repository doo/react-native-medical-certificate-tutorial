...
export class MedicalCertificateResultsScreen extends React.Component {

  public static readonly PAGE_NAME = "Medical Certificate Result";
  public static result?: MedicalCertificateScannerResultData;

  render() {
    const certificate = MedicalCertificateResultsScreen.result!;
